  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center overflow-hidden">
        ...
        {/* 1. HERO SECTION (Layout em Coluna com Imagem Ampla Abaixo) */}
        <section id="home" className="relative w-full max-w-7xl px-4 md:px-6 pt-32 md:pt-40 pb-16 md:pb-24 mx-auto flex flex-col items-center text-center">

          {/* BLOCO DE TEXTO: mb reduzido (mb-4 md:mb-6) para subir a foto */}
          <div className="flex flex-col items-center z-10 reveal-on-scroll mb-4 md:mb-6">

            {/* HIGHLIGHT DIMINUÍDO (Padding, Margin e Fonte reduzidos) */}
            <div className="inline-flex items-center gap-1.5 px-3 py-1 mb-4 md:mb-5 rounded-full bg-white/60 dark:bg-white/5 backdrop-blur-md border border-white/50 dark:border-white/10 shadow-sm">
              <div className="flex text-yellow-500 text-[9px] md:text-xs">
                ★★★★★
              </div>
              <span className="text-[9px] md:text-xs font-medium tracking-wide text-emerald-900 dark:text-emerald-100/90">
          ...
          {/* FOTO PRINCIPAL: Ocupa a tela (Viewport Height) e está mais alta devido ao mb reduzido acima */}
          <div className="w-full relative z-10 reveal-on-scroll delay-100">
            <div className="relative w-full h-[60vh] md:h-[75vh] rounded-[2rem] md:rounded-[3rem] overflow-hidden bg-white/40 dark:bg-white/5 backdrop-blur-sm border border-white/50 dark:border-white/10 shadow-2xl p-2 md:p-3">
              <div className="relative w-full h-full rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden bg-black/10 dark:bg-black/40">
                ...
                <div className="absolute inset-0 flex items-center justify-center text-emerald-900/40 dark:text-emerald-100/20 text-xs md:text-sm font-medium z-20">
                  [Imagem Hero: Panorâmica e Imersiva]
                </div>
              </div>
            </div>
          </div>
        ...
        {/* 3. ACOMODAÇÕES SECTION (Carrossel Horizontal Elegante) */}
        <section id="acomodacoes" className="w-full max-w-7xl px-4 md:px-6 py-16 md:py-24 scroll-mt-20">
          ...
          {/* Container com scroll horizontal, escondendo a barra de rolagem (hide-scrollbar) e ativando o "snap" para parar a foto no meio certinho */}
          <div className="flex gap-4 md:gap-6 overflow-x-auto snap-x snap-mandatory hide-scrollbar pb-8 pt-4 px-4 -mx-4 md:mx-0 md:px-0">

            {/* Card 1 - LINK */}
            <Link href="/acomodacoes/bangalo-jacuzzi" className="group shrink-0 w-[260px] md:w-[320px] flex flex-col p-3 md:p-4 rounded-[2rem] bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-white/50 dark:border-white/10 shadow-lg hover:bg-white/60 dark:hover:bg-white/10 transition-all duration-500 reveal-on-scroll snap-center">
              <div className="w-full aspect-[4/5] md:aspect-[4/5] rounded-[1.5rem] bg-black/5 dark:bg-black/30 mb-4 overflow-hidden relative">
                <div className="absolute inset-0 flex items-center justify-center text-emerald-900/30 dark:text-emerald-100/20 text-xs">Foto Bangalô c/ Jacuzzi</div>
              </div>
            ...
            {/* Card 2 - LINK */}
            <Link href="/acomodacoes/bangalo" className="group shrink-0 w-[260px] md:w-[320px] flex flex-col p-3 md:p-4 rounded-[2rem] bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-white/50 dark:border-white/10 shadow-lg hover:bg-white/60 dark:hover:bg-white/10 transition-all duration-500 reveal-on-scroll delay-100 snap-center">
              <div className="w-full aspect-[4/5] md:aspect-[4/5] rounded-[1.5rem] bg-black/5 dark:bg-black/30 mb-4 overflow-hidden relative">
              ...
              <div className="px-2 pb-2 flex justify-between items-end">
                <h3 className="text-lg font-serif font-medium text-emerald-950 dark:text-emerald-50">Bangalô</h3>
                <button className="text-[11px] uppercase tracking-wider font-semibold text-emerald-600 dark:text-emerald-400 flex items-center gap-1 group-hover:gap-2 transition-all">
                  Saber mais <span>→</span>
                </button>
              </div>
            ...
            {/* Card 3 - LINK */}
            <Link href="/acomodacoes/chale-family" className="group shrink-0 w-[260px] md:w-[320px] flex flex-col p-3 md:p-4 rounded-[2rem] bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-white/50 dark:border-white/10 shadow-lg hover:bg-white/60 dark:hover:bg-white/10 transition-all duration-500 reveal-on-scroll delay-200 snap-center">
              <div className="w-full aspect-[4/5] md:aspect-[4/5] rounded-[1.5rem] bg-black/5 dark:bg-black/30 mb-4 overflow-hidden relative">
            ...
            {/* Card 4 - LINK */}
            <Link href="/acomodacoes/chale-jacuzzi" className="group shrink-0 w-[260px] md:w-[320px] flex flex-col p-3 md:p-4 rounded-[2rem] bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-white/50 dark:border-white/10 shadow-lg hover:bg-white/60 dark:hover:bg-white/10 transition-all duration-500 reveal-on-scroll delay-300 snap-center">
              <div className="w-full aspect-[4/5] md:aspect-[4/5] rounded-[1.5rem] bg-black/5 dark:bg-black/30 mb-4 overflow-hidden relative">
            ...
            {/* Elemento fantasma para dar um "respiro" no final do scroll no Mobile */}
            <div className="shrink-0 w-2 md:w-8"></div>
          </div>
        </section>
        {/* 4. EXPERIÊNCIAS */}
